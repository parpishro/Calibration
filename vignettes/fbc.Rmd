...
| -------------                                    | ---------              | -----           | -------             |
| True field calibration inputs ($\kappa$)         | `kappa="beta"`         | `k0=0.5`        | `k1=1.1` & `k2=1.1` |
|                                                  |                        |                 |                     |
...
Initial value arguments (`k0`, `ts0`, `as0`, `tb0`, `ab0`, `ss0`, `sb0`, `se0`) are scalers or vectors (only `k0`, `ts0`, `as0`, `tb0`, `ab0`) with same length as number of parameters in the same class. For example if there are five calibration parameters, `k0` can either be a scaler, in which case the initial value for all calibration parameters will be set to that scaler value, or a vector of length five that supplies the initial values for all calibration parameters.
